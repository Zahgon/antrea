...
func (c *SystemV1beta1Client) SupportBundles() SupportBundleInterface {
	...
	return *new(SupportBundleInterface)
}
...
func NewForConfigOrDie(c *rest.Config) *SystemV1beta1Client { _ = "STUB: not implemented"; return nil }

// New creates a new SystemV1beta1Client for the given RESTClient.
func New(c rest.Interface) *SystemV1beta1Client { _ = "STUB: not implemented"; return nil }
