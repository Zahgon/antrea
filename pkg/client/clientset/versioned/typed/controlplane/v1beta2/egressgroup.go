...
type EgressGroupInterface interface {
	Get(ctx context.Context, name string, opts v1.GetOptions) (*controlplanev1beta2.EgressGroup, error)
	List(ctx context.Context, opts v1.ListOptions) (*controlplanev1beta2.EgressGroupList, error)
...
type egressGroups struct {
	*gentype.ClientWithList[*controlplanev1beta2.EgressGroup, *controlplanev1beta2.EgressGroupList]
}
